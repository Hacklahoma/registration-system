      ...
      <div className="center">
        ...
        <div className="card login-card">
          <div className="card-body">
            <h5 className="page-title">Confirmation</h5>
            <h6 className="confirmation-email-text">
              An email has been sent to{" "}
              <span className="user-email">email@gmail.com</span> to confirm
              your account. Follow the link in the email to make your account.
            </h6>
